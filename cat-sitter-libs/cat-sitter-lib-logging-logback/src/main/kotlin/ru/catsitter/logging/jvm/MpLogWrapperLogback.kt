package ru.catsitter.logging.jvm
...
import ru.catsitter.logging.common.IMpLogWrapper
...
class MpLogWrapperLogback(
    ...
    private fun log(
        ...
        logger.log(object : LoggingEvent {
            ...
            override fun getKeyValuePairs(): MutableList<KeyValuePair> = objs?.mapNotNull {
